...
function Carousel(props) {
    ...
    return (
        <div>
            <div className="container--Carouselhome1">
                <div className='topCarouselhome1'>
                    <div className="title--Carouselhome1">
                        <h3>{props.title}</h3>
                    </div>
                    <div className='view--Carouselhome1'>
                        <button>VIEW ALL</button>
                    </div>
                </div>
                <div className='carousel--Carouselhome1'>
